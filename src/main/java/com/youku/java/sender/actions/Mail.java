...
public class Mail { 
	...
	public boolean setSubject(String mailSubject) { 
		...
		try{ 
			sun.misc.BASE64Encoder base64 = new BASE64Encoder();
			   String subject = new String(base64.encode(mailSubject.getBytes("UTF-8")));
			   mimeMsg.setSubject("=?UTF-8?B?" + subject + "?=");
	...
	public boolean setBody(String mailBody) { 
		...
		//	sun.misc.BASE64Encoder base64 = new BASE64Encoder();
		//	String subject = new String(base64.encode("中文".getBytes("UTF-8")));
